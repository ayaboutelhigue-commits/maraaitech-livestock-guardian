...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'alert.status_ok': { en: 'No Alert — All Good', ar: 'لا يوجد تنبيه — كل شيء بخير', fr: 'Aucune alerte — Tout va bien' },
  'alert.status_alert': { en: 'ALERT', ar: 'تنبيه', fr: 'ALERTE' },
  'alert.no_data': { en: 'No live data. Connect your collar device.', ar: 'لا توجد بيانات مباشرة. قم بتوصيل جهاز الطوق.', fr: 'Aucune donnée en direct. Connectez votre collier.' },
  'alert.current_readings': { en: 'Current readings', ar: 'القراءات الحالية', fr: 'Lectures actuelles' },
